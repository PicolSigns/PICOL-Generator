...
(function ($) {
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			buttonImage:		'common/js/jquery/colorpicker/images/ui-colorpicker.png',
		...
		open: function() {
			...
			if (!that.opened) {
				...
				//x		= offset.left;
				x		= ($(window).width() / 2) - (that.dialog.outerWidth() / 2);
				//y		= offset.top + that.element.outerHeight();
				y		= ($(window).height() / 2) - (that.dialog.outerHeight() / 2);;
